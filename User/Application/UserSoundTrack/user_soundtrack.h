...
namespace Buzzer::Soundtracks
{
    ...
    constexpr MusicUnit immortal_ash[] = {
        {330,0},
    ...
    constexpr MusicUnit idoratrize_world[] = {
        {680,0,0},
    ...
    constexpr MusicUnit watery_graves[] = {
        {424,0,0},
    ...
    constexpr uint16_t watery_graves_u16[] = {426,
    ...
    constexpr uint16_t oriental_dream_2[] = {
